...
\todo{Parler de KYD et faire une refs}
...
sur des “Cloud”, l'abscence de résultats pouvant justifier \todo{Pas trop compris la phrase de Yves : Orientez plus haut niveau que votre travail se résumé à du dev de code} le développement de notre propre
application.
...
%%  \hline
%%      & \bf HP Performance & \bf CosBench & \bf Cloudcreener & \bf \KYD  \\
%%  \hline
...
%%  \hline
%%   \bf\centering Limites & Propriétaire & Swift Storage et S3 & Propriétaire, tests spécifiques & limites des Cloud \\
%%  \hline
...
\todo{YC : décrivez en 2 phrases un scénar pour savoir qui fait quoi et quand, l'ordre des actions, comme à quel moment execo est utilisé car jamais explicitement dit.}
\newpage
...
et Google Drive seront donc des choix beaucoup plus logiques
...
\todo{Dernier test + conclusion à terminer}
...
solutions "\textit{Cloud}"\todo{YC : replacez la problématique, votre étude puis votre développement. Et ce que le développement à permis de mesurer}.\\
...
entraîné un manque d'homogénéité des moyennes\todo{YC : vous parlez reproductibilité ? Pas top clair}. Dans une telle situation, \KYD
n'aurait pas pu fournir de résultat valable et nos recherches auraient prouvées
qu'un tel outil n'était pas réalisable\todo{YC : dépend de votre réponse avant, mais à priori, à retirer}.\\
